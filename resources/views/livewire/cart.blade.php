<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-white">
                <div class="row">
                    <div class="col-md-6"><h3 class="font-weight-bold">produk List</h3></div>
                    ...
                    @forelse($products as $product)
                        <div class="col-md-3 mb-3" :key="{{$product->id}}">
                            <div class="card" wire:click="addItem({{$product->id}})" style="cursor:pointer">                 
                                ...
                                <h6 class="text-center font-weight-bold" style="color: rebeccapurple">Rp {{number_format($product->price,0,',','.')}}</h6>
                            </div>
                        </div>
                    @empty
                    <div class="col-sm-12 mt-5">
                        <h2 class="text-center font-weight-bold text-primary">Produk Tidak Ditemukan</h2>                    
                    </div>                        
                    @endforelse                                     
                </div>
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-header bg-white">
                <h3 class="font-weight-bold">Kerajang Belanjaan</h3>                              
            </div>
            <div class="card-body">
        ...
        <div class="card mt-4">
            <div class="card-body">
                ...
                <h5 class="font-weight-bold" id="oke">Total: Rp {{ number_format($summary['total'],0,',','.') }} </h5>

                <div class="row mt-4">
                    <div class="col-sm-6">
                         <button wire:click="enableTax" class="btn btn-primary btn-block btn-sm">Biaya Admin</button>
                    </div>
                    <div class="col-sm-6">
                          <button wire:click="disableTax" class="btn btn-info btn-block btn-sm">Tanpa Biaya Admin</button>
                    </div>      
                </div>
              
              <div class="form-group mt-4">
                <input type="number" wire:model="payment" class="form-control" id="payment" placeholder="Uang Bayar Pelanggan">
                ...
                <form wire:submit.prevent="handleSubmit">
                    ...
                    <div class="mt-4">
                        <button wire:ignore type="submit" id="saveButton" disabled class="btn btn-success btn-block" id="saveButton"><i class="fas fa-save fa-lg"></i>Simpan Transaksi</button>
                    </div>
                </form>
            </div>
        </div>
